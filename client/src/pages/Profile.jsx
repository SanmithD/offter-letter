import { BriefcaseIcon, Calendar1Icon, DownloadIcon, Mail, PhoneIcon, School2, Share2, User2Icon } from "lucide-react";
              ...
              <div className="mt-4 sm:mt-0 flex-1">
                ...
                <div className="flex flex-wrap items-center gap-4 mt-3 text-sm text-gray-700">
                  <div className="flex items-center gap-1">
                    ...
                    <span>Born {new Date(authUser?.dob).toLocaleDateString()}</span>
                  </div>
                  <div className="flex items-center gap-1">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="rounded-2xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="text-gray-700">
                {authUser?.experience ? (
                  ...
                  <p className="text-gray-500 italic">No experience mentioned</p>
                )}
              </div>
            </div>
            ...
            <div className="rounded-2xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="flex flex-wrap gap-2">
                {Array.isArray(authUser?.skills) && authUser?.skills.length > 0 ? (
            ...
            <div className="rounded-2xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                ...
                <button className="w-full cursor-pointer flex justify-center items-center gap-2 px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-500 transition-colors duration-200 font-medium">
                  <span><DownloadIcon/></span> Download Resume
                </button>
                <button className="w-full cursor-pointer flex justify-center items-center gap-2 px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-500 transition-colors duration-200 font-medium">
                  <span><Share2/></span> Share Profile
                </button>
                <button onClick={handleLogout} className="w-full cursor-pointer px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-500 transition-colors duration-200 font-medium">
                  Logout
                </button>
              </div>
            </div>
